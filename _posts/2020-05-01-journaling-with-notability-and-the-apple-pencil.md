...
My earliest journals were paper organizers that I used in my undergraduate years at The University of Texas at Austin that I used to schedule my classes and also capture my thoughts about the people, places, and events in my life. I have to admit that it's cool revisit the things that seemed important to me when I was an electrical engineering student.

After I graduated and started my career, I graduated to notebooks, and I have a stack of them in my office and up in the attic in my house. While some of these journals are little more than meeting notes, I would often write down my thoughts about those years, too. I eventually started using paper notebooks that were dedicated to journaling.

I loved the physicality of paper notebooks and writing in them with a pen. I've found that typing in a journal didn't have the psychological weight of writing. I have dozens of electronic journals in cloud storage, but they aren't as meaningful as my stack of paper journals.

I've tried many types of paper based notebooks over the years ranging from calendar based planners to dedicated journals. I eventually settled on my preferred configuration:

* Lay-flat wire binding that securely holds the pages together
...
* An elastic closure that firmly keeps the journal closed
* A bookmark
...
This is a [link to the notebook](https://amzn.to/3aPDK4s) that met all of these requirements, and I loved it!
...
All of these applications provided some form of stylus support, and I tried them with a variety of styli, and they worked to some degree. Most of them had a "drawing" feature that provide a way to make handwritten notes. Many of them could convert my handwriting to text, search through my notes based on a text string, and provide a variety of colors for my journal entries. They all synced my information across multiple devices so I could access my journal on a tablet, laptop, or desktop.
...
* The writing experience has to be close to using a pen and paper.
...
* There should be a basic set of very useful features
...
I initially used Notability with the same simple styli I used with other apps. However, the release of the [Apple Pencil](https://amzn.to/35jx7Gk) made Notability even more of a joy to use.  
...
Notability also has an "infinite scroll" approach to pages. That means that you keep writing and the page keeps scrolling as your write. Some note-taking tools force you to go to a new page when you reach the bottom of the current page. I find that to be very distracting and takes away from the writing experience.

You can also chose from a variety of cloud providers to automatically back up your entries in Notability. I use Google Drive, and I like knowing that if I ever lose my iPad, I can always get to my Journal entries in either PDF or Notability's particular format.

Notability is very simple to use, and the app creators have resisted the urge to throw every bell and whistle into the app. For example, there are a set number of colors to choose from instead of having a huge number of options from a color wheel. Also, Notability selects and erases based on strokes instead of pixels. So, getting "close enough" works for when you need to manipulate something on the page.
...
Notability will automatically put a date and time stamp on my journals, but I've started adding putting the date at the beginning of each entry so that this shows up in the filenames of the backups stored in Google Drive. That makes it easy to know exacty when I wrote each entry.

### Using Journal Prompts

While I don't stick to a prescribed method for my journal entries, I use a book called [365 Journal Writing Ideas](https://amzn.to/3d4EqVa) to choose a  use a book of journal prompts from time to time to find interesting things to put in my journal. I usually copy the prompt from an electronic version of the book into a text box and then hand write my response. 

Here are some of my favorite prompts from the that I've answered over the past few months:
...
These prompts are great for the days when I don't have anything that seems worth writing down. It's been fun to look back on my responses the prompts a few months ago, and I imagine that it will be very interesting to look back on them a few years from now.

## Future Upgrades

I really like using Notability and the Apple Pencil to record my journal entries. It's the combination I spent years trying to find. However, I do have few ideas for how I want to upgrade my setup.

### 12.9-inch iPad Pro (4th Generation)

My current iPad is roughly two model years old, and, like most iPads, it's rock solid. For my needs, it still works as fast as the day I took it out of Apple's artistic packaging. However, the 4th Genration 12.9 inch iPad Pro has the new camera array, and, I'd love to have that upgrade. I don't often take pictures with my iPad, but it's nice to know I have a couple of solid cameras when the need arises.

### Apple Pencil (Second Generation)

I'm currently using the first Apple Pencil, and I'd like to eventually upgrade to the [Apple Pencil (2nd Generation)](https://amzn.to/3f6RhYu). It's reportedly even more buttery smooth, and it magnetically attaches to the iPad.

### Apple Magic Keyboard

I've also been keeping my eye on [Apple's Magic Keyboad](https://amzn.to/35kWgQO). I think it's way too expensive now, but I could see myself buying one when the price eventually goes down. It would be nice to have a keyboard, but I would primarily use it as a stand for the iPad.
